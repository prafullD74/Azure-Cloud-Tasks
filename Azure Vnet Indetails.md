# Virtual Network
1. [Azure networking services overview](#azure-networking-services-overview)
2. [Hub-spoke network topology in Azure](#hub-spoke-network-topology-in-azure)
3. [Architecture best practices for Azure Virtual Network](#architecture-best-practices-for-azure-virtual-network-1)
4. [Virtual Network](#virtual-network)
5. [Virtual Network concepts](#virtual-network-concepts)
6. [Azure Virtual Network](#azure-virtual-network)
7. [Azure virtual network traffic routing](#azure-virtual-network-traffic-routing)
8. [Azure Accelerated Networking](#azure-accelerated-networking)
9. [Network Interface](#network-interface)
10. [Application security groups](#application-security-groups)
11. [Azure network security groups](#azure-network-security-groups)
12. [Service endpoints](#service-endpoints)
13. [Service tag](#service-tag)
14. [Azure Private Link](#azure-private-link)
15. [Azure DNS (Domain Name System)](#azure-dns-domain-name-system)
16. [Azure Bastion](#azure-bastion)
17. [Azure Route Server](#azure-route-server)
18. [NAT Gateway](#nat-gateway)
19. [Azure Load Balancer](#azure-load-balancer)
20. [Azure Application Gateway](#azure-application-gateway)
21. [Azure Front Door](#azure-front-door)
22. [VPN Gateway](#vpn-gateway)
23. [ExpressRoute](#expressroute)
24. [Azure Virtual WAN](#azure-virtual-wan)
25. [Network security](#network-security)
    - [Azure Firewall Manager](#azure-firewall-manager)
    - [Azure Firewall](#azure-firewall)
    - [Azure Web Application Firewall](#azure-web-application-firewall)
    - [DDoS Protection](#ddos-protection)
26. [Network Management and Monitoring](#network-management-and-monitoring)
    - [Azure Network Watcher](#azure-network-watcher)
    - [Azure Monitor](#azure-monitor)
    - [Azure Virtual Network Manager](#azure-virtual-network-manager)
27. [Other](#other)
28. [Question and Answer](#question-and-answer)
